  ...
  <div class="row">
    <div class="col-lg-9">
          ...
          <div class="toolbox-item toolbox-sort">
            ...
            <div class="select-custom">
              <select
                ...
                v-model="orderBy"
              >
                <option :value="{ type: 'products.name', by: 'asc' }">
                  Default sorting
                </option>
                <!--
										...
										-->
                <option :value="{ type: 'products.created_at', by: 'asc' }">
                  Sort by newness
                </option>
                <option :value="{ type: 'product_prices.price', by: 'asc' }">
                  Sort by price: low to high
                </option>
                <option :value="{ type: 'product_prices.price', by: 'desc' }">
            ...
            <a href="#" class="sorter-btn" title="Set Ascending Direction"
              ><span class="sr-only">Set Ascending Direction</span></a
            >
          </div>
          <!-- End .toolbox-item -->
        </div>
      ...
      <div class="row row-sm">
        <div
          v-for="productEntry in products"
          :key="productEntry.id"
          ...
          <div class="product-default inner-quickview inner-icon">
            <figure>
              <a :href="'/product/' + productEntry.link_name">
                <img
                  :src="
                    'https://res.cloudinary.com/pixel-penguin/image/upload/c_fill,h_200,w_200/v1/' +
                    productEntry.gallery[0].image_name +
                    '.jpg'
                  "
                />
                <img
              ...
              <a
                :onClick="
                  'Hub.$refs.showItem.getProductInfo(' + productEntry.id + ')'
                "
                class="btn-quickview"
                title="Quick View"
              ...
              <div class="price-box">
                <div v-if="productEntry.prices[0].is_discount">
                  <span class="old-price"
                    >{{ currency
                    }}{{ addCommas(productEntry.prices[0].price) }}</span
                  >
                  <span class="product-price"
                    >From {{ currency
                    }}{{
                      addCommas(productEntry.prices[0].discounted_price)
                    }}</span
                  >
                </div>
                <div v-else>
                ...
                <li v-for="category1 in productCategories" :key="category1.id">
                  ...
                  <ul v-if="category1.children.length > 0">
                    <li
                      ...
                      :key="category2.id"
                    >
                      <a v-if="category2.children.length > 0"
                        >{{ category2.name
                        }}<i
                ...
                >
                  <figure>
                    <a :href="'/product/' + featuredProduct.link_name">
                      <img
                        :src="
                          'https://res.cloudinary.com/pixel-penguin/image/upload/c_fill,h_200,w_200/v1/' +
                          featuredProduct.gallery[0].image_name +
                          '.jpg'
                        "
                      />
                    </a>
                  ...
                  <div class="product-details">
                    ...
                    <div class="price-box">
                      <span class="product-price"
                        >{{ currency
                        }}{{ featuredProduct.prices[0].price }}</span
                      >
                    </div>
                    <!-- End .price-box -->
                  </div>
